...
void DescriptorSet::bindBuffer(uint32_t binding, vk::ShaderStageFlags stages, vk::DescriptorType type)
{
...
void DescriptorSet::bindImage(uint32_t binding, vk::ShaderStageFlags stages)
{
...
void DescriptorSet::build()
{
    ...
    layout = engine->device.createDescriptorSetLayout(layoutInfo);
